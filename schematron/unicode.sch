...
<!--   <xsl:import href="http://niso-sts.org/sts4i-tools/schematron/NISOSTS_lib.xsl"/>-->
   ...
   <pattern id="LATINSMALLLETTERNWITHLONGRIGHTLEG">
      <rule context="/*" id="LATINSMALLLETTERNWITHLONGRIGHTLEG_rule">
         <let name="start" value="384"/>
         <let name="end" value="591"/>
         <let name="this-blocks-cps-used" value="$uni-chars[. ge $start][. le $end]"/>
         <let name="value" value="414"/>
         <report id="LATINSMALLLETTERNWITHLONGRIGHTLEG_report"
                 test="(some $u in $uni-chars satisfies ($value = $u))                 ">
          This document contains the char 'LATIN SMALL LETTER N WITH LONG RIGHT LEG' (019E, &#x019E;). 
          Use the char 'GREEK SMALL LETTER ETA' (03B7) instead. 
          <sbf:xsl-fix href="xslt-fixes/char_misuse.xsl"
                         mode="LATINSMALLLETTERNWITHLONGRIGHTLEG"/>
         </report>
      </rule>
   </pattern>
   <pattern id="LATINSMALLLETTERFWITHHOOK">
      <rule context="/*" id="LATINSMALLLETTERFWITHHOOK_rule">
         <let name="start" value="384"/>
         <let name="end" value="591"/>
         <let name="this-blocks-cps-used" value="$uni-chars[. ge $start][. le $end]"/>
         <let name="value" value="402"/>
         <report id="LATINSMALLLETTERFWITHHOOK_report"
                 test="(some $u in $uni-chars satisfies ($value = $u))                 ">
          This document contains the char 'LATIN SMALL LETTER F WITH HOOK' (0192, &#x0192;). 
          Use the char 'Mathematical Italic Small F' (1D453) instead. 
          <sbf:xsl-fix href="xslt-fixes/char_misuse.xsl" mode="LATINSMALLLETTERFWITHHOOK"/>
         </report>
      </rule>
   </pattern>
   <pattern id="CYRILLICSMALLLETTERES">
      <rule context="/*" id="CYRILLICSMALLLETTERES_rule">
         <let name="start" value="1024"/>
         <let name="end" value="1279"/>
         <let name="this-blocks-cps-used" value="$uni-chars[. ge $start][. le $end]"/>
         <let name="value" value="1089"/>
         <report id="CYRILLICSMALLLETTERES_report"
                 test="(some $u in $uni-chars satisfies ($value = $u))                 and (count($this-blocks-cps-used) lt 10)">
          This document contains the char 'CYRILLIC SMALL LETTER ES' (0441, &#x0441;). 
          Use the char 'LATIN SMALL LETTER C' (0063) instead. 
          <sbf:xsl-fix href="xslt-fixes/char_misuse.xsl" mode="CYRILLICSMALLLETTERES"/>
         </report>
      </rule>
   </pattern>
   <pattern id="CYRILLICSMALLLETTEREF">
      <rule context="/*" id="CYRILLICSMALLLETTEREF_rule">
         <let name="start" value="1024"/>
         <let name="end" value="1279"/>
         <let name="this-blocks-cps-used" value="$uni-chars[. ge $start][. le $end]"/>
         <let name="value" value="1092"/>
         <report id="CYRILLICSMALLLETTEREF_report"
                 test="(some $u in $uni-chars satisfies ($value = $u))                 and (count($this-blocks-cps-used) lt 10)">
          This document contains the char 'CYRILLIC SMALL LETTER EF' (0444, &#x0444;). 
          Use the char 'GREEK PHI SYMBOL' (03D5) instead. 
          <sbf:xsl-fix href="xslt-fixes/char_misuse.xsl" mode="CYRILLICSMALLLETTEREF"/>
         </report>
      </rule>
   </pattern>
   ...
   <pattern id="MODIFIERLETTERSMALLNWITHRETROFLEXHOOK">
      <rule context="/*" id="MODIFIERLETTERSMALLNWITHRETROFLEXHOOK_rule">
         <let name="start" value="7552"/>
         <let name="end" value="7615"/>
         <let name="this-blocks-cps-used" value="$uni-chars[. ge $start][. le $end]"/>
         <let name="value" value="7599"/>
         <report id="MODIFIERLETTERSMALLNWITHRETROFLEXHOOK_report"
                 test="(some $u in $uni-chars satisfies ($value = $u))                 ">
          This document contains the char 'MODIFIER LETTER SMALL N WITH RETROFLEX HOOK' (1DAF, &#x1DAF;). 
          Use the char 'GREEK SMALL LETTER ETA' (03B7) instead. 
          <sbf:xsl-fix href="xslt-fixes/char_misuse.xsl"
                         mode="MODIFIERLETTERSMALLNWITHRETROFLEXHOOK"/>
         </report>
      </rule>
   </pattern>
   ...
   <pattern id="COMBININGENCLOSINGCIRCLE">
      <rule context="/*" id="COMBININGENCLOSINGCIRCLE_rule">
         <let name="start" value="8400"/>
         <let name="end" value="8447"/>
         <let name="this-blocks-cps-used" value="$uni-chars[. ge $start][. le $end]"/>
         <let name="value" value="8413"/>
         <report id="COMBININGENCLOSINGCIRCLE_report"
                 test="(some $u in $uni-chars satisfies ($value = $u))                 ">
          This document contains the char 'COMBINING ENCLOSING CIRCLE' (20DD, &#x20DD;). 
          Use the char 'WHITE CIRCLE' (25CB) instead. 
   ...
   <pattern id="COMBININGRIGHTARROWABOVE">
      <rule context="/*" id="COMBININGRIGHTARROWABOVE_rule">
         ...
         <report id="COMBININGRIGHTARROWABOVE_report"
                 test="(some $u in $uni-chars satisfies ($value = $u))                 ">
          This document contains the char 'COMBINING RIGHT ARROW ABOVE' (20D7, &#x20D7;). 
          Use the char 'RIGHTWARDS ARROW' (2192) instead. 
   ...
   <pattern id="COMBININGENCLOSINGSQUARE">
      <rule context="/*" id="COMBININGENCLOSINGSQUARE_rule">
         ...
         <report id="COMBININGENCLOSINGSQUARE_report"
                 test="(some $u in $uni-chars satisfies ($value = $u))                 ">
          This document contains the char 'COMBINING ENCLOSING SQUARE' (20DE, &#x20DE;). 
          Use the char 'WHITE SQUARE' (25A1) instead. 
   ...
   <pattern id="COMBININGANTICLOCKWISEARROWABOVE">
      <rule context="/*" id="COMBININGANTICLOCKWISEARROWABOVE_rule">
         ...
         <report id="COMBININGANTICLOCKWISEARROWABOVE_report"
                 test="(some $u in $uni-chars satisfies ($value = $u))                 ">
          This document contains the char 'COMBINING ANTICLOCKWISE ARROW ABOVE' (20D4, &#x20D4;). 
          Use the char 'TOP ARC ANTICLOCKWISE ARROW' (293A) instead. 
          <sbf:xsl-fix href="xslt-fixes/char_misuse.xsl"
